...
*/
console.log( '\nOperation:' );
var operation = justMod2Or3.reduce(function(anterior,atual,index,array){
...
*/
console.log( '\nOperation 2:' );
var operation2 = justMod2Or3.reduceRight(function(anterior,atual,index,array){
...
console.log("o resultado sempre será negativos pois as referencias desses objetos são diferentes");
