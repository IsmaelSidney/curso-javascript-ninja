(function(){
  ...
  */
  ...
  var person1 = { name :'ismael',lastName:'barroso'}
  var person2 = { name :'joana',lastName:'pereira'}
...
console.log(getFullName.call(person2));
  ...
  */
  function sum () {
    ...
    return Array.prototype.reduce.call(arguments,function(lastItem,actualItem) {
