...
pessoa.andar=function(metros){
    if(metros === undefined){
        return "Para andar digite a quantidade de metros!"
    }else{
...
*/
pessoa.nomeCompleto()//Ismael Barroso

/*
Qual a idade da pessoa? (Use a instrução para responder e comentários
inline ao lado da instrução para mostrar qual foi a resposta retornada)
*/
pessoa.mostrarIdade()//34
...
*/
pessoa.caminhouQuantosMetros//80
...
// Agora, apresente-se ;)
pessoa.apresentacao()
'Olá, eu sou  o  Ismael Barroso, tenho 33 anos,1.81,meu peso é 100Kg e, só hoje, eu já caminhei 1000 metros!'
